...
public  class RegistrarActivitymio extends Activity {
    ListView Arreglo ;
...
//	String camino="/mnt/sdcard/Android/data/BDRegistros.db";
	String camino="/sdcard/Android/data/BDRegistros.db";
	...
	Button B3;
	boolean esperaXclick=false,parearse=false,escribirdatos=false,tiempo=false,noactivoBT=false,
				...
				if (data.hasExtra("EXITO")) {
					...
					switch (Valor) {
						...
						case 8:
							...
							MediaPlayer reproSonido = MediaPlayer.create(RegistrarActivitymio.this, R.raw.fin);
							reproSonido.start();
							guardar = true;
							deregistrar = true;
							//lleva la aplicacion al background
						...
						case 16:
							...
							MediaPlayer reproSonido1 = MediaPlayer.create(RegistrarActivitymio.this, R.raw.elecaidos);
							reproSonido1.start();
						...
						case 17:
							...
							MediaPlayer reproSonido2 = MediaPlayer.create(RegistrarActivitymio.this, R.raw.perdidacom);
							reproSonido2.start();
...
//				   Toast.makeText(getBaseContext(), "Nuevo Paciente", Toast.LENGTH_LONG).show();
		   if  (!(Archivo.exists() )){
			   Intent i = new Intent(RegistrarActivitymio.this, entraID.class);
 ...
 //         startActivityForResult(i,REQUEST_CODE);
    ...
    public void onclickregistrar(View BRegistrar){
      ...
      if (!soloicono.equals("2")){
         Intent intent = new Intent(RegistrarActivitymio.this,BluetoothChat.class);
